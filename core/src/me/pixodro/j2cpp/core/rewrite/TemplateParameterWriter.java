...
public class TemplateParameterWriter extends NodeWriter {
   ...
   * @param visitor
   */
  public TemplateParameterWriter(final Scribe scribe, final ASTWriterVisitor visitor, final NodeCommentMap commentMap) {
    super(scribe, visitor, commentMap);
  }

  protected void writeTemplateParameter(final ICPPASTTemplateParameter parameter) {
  ...
  private void writeTemplatedTypeTemplateParameter(final ICPPASTTemplatedTypeTemplateParameter templated) {
    scribe.print(TEMPLATE_LESS_THAN);
    final ICPPASTTemplateParameter[] params = templated.getTemplateParameters();
  ...
  private void writeSimpleTypeTemplateParameter(final ICPPASTSimpleTypeTemplateParameter simple) {
