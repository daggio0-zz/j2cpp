...
public class TextEditUtil {
   ...
   */
  public static MultiTextEdit flatten(final TextEdit edit) {
    final MultiTextEdit result = new MultiTextEdit();
    flatten(edit, result);
    return result;
  }

  private static void flatten(final TextEdit edit, final MultiTextEdit result) {
    if (edit.hasChildren()) {
   ...
   * 
   * @param edit1
   *          the edit to merge with edit2
   * @param edit2
   *          the edit to merge with edit1
   * @return the merged tree
   * @throws MalformedTreeException
   *           if the two edits ovelap
   */
  public static TextEdit merge(final TextEdit edit1, final TextEdit edit2) {
  ...
  private static void merge(final TextEdit edit1, final TextEdit edit2, final MultiTextEdit result) {
    if ((edit1 instanceof MultiTextEdit) && (edit2 instanceof MultiTextEdit)) {
      final MultiTextEdit multiTextEdit1 = (MultiTextEdit) edit1;
      if (!multiTextEdit1.hasChildren()) {
        result.addChild(edit2);
        return;
      }

      final MultiTextEdit multiTextEdit2 = (MultiTextEdit) edit2;
      if (!multiTextEdit2.hasChildren()) {
        result.addChild(edit1);
        return;
      }

      final TextEdit[] children1 = multiTextEdit1.getChildren();
      final TextEdit[] children2 = multiTextEdit2.getChildren();
      ...
      final TextEdit[] children = edit1.getChildren();
      ...
      final TextEdit[] children = edit2.getChildren();
   ...
   * 
   * @param edit
   *          the edit to determine delta for.
   * @return the delta
   */
  public static int delta(final TextEdit edit) {
    int delta = 0;
    for (final TextEdit child : edit.getChildren()) {
      delta += delta(child);
    }
    delta += ownDelta(edit);
    return delta;
  ...
  private static int ownDelta(final TextEdit edit) {
