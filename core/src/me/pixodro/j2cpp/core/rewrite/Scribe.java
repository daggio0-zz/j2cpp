...
public class Scribe {
  ...
  public void println(final String code) {
    print(code);
    newLine();
  }

  public void print(final String code, final String code2) {
    print(code);
    buffer.append(code2);
  }

  public void println(final String code, final String code2) {
    print(code, code2);
    newLine();
  }

  public void println(final String code, final char[] code2) {
    print(code);
    buffer.append(code2);
    newLine();
  }

  public void printSpaces(final int number) {
    indentIfNewLine();
  ...
  public void print(final char code) {
    indentIfNewLine();
    buffer.append(code);
  }
  ...
  public void println(final char[] code) {
    print(code);
    newLine();
  }

  public void printStringSpace(final String code) {
    print(code);
    printSpace();
  }
